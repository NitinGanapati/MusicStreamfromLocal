...
// import 'package:musics/pages/PlaylistSongsPage.dart';
...
class PlaylistsongWidget extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _PlaylistsongWidget();
}

  class _PlaylistsongWidget extends State<PlaylistsongWidget>{
  ...
  @override
  void didUpdateWidget(covariant PlaylistsongWidget oldWidget) {
  ...
  return Column(
    children: [
      Container(
        // child: Text("Playlist Name : "+widget.playListName)
        child: ListTile(
          leading: Text("Playlist : "+widget.playListName, style: TextStyle(fontSize: 16),),
          // trailing:   ElevatedButton(onPressed: (){
          //     String k = widget.playListName;
          //       var songs = db.DBHelper().getMusicByPlaylist(widget.playListName);
          //
          //     Navigator.push(context, MaterialPageRoute(builder: (_)=> Scaffold(
          //       appBar: AppBar(title: Text("Songs"),
          //           automaticallyImplyLeading:false,
          //         leading: IconButton(onPressed: (){
          //           Navigator.pop(context,widget.songs[currentIndex]);
          ...
          //               final i = snapshot.data![index]["id"];
          //               print("HI i am id {$i}");
          //               // final id = index;
          //               return Dismissible(
          ...
          //                 child: ListTile(
          //                   trailing: (widget.songs[currentIndex]["title"] == snapshot.data![index]["title"])? Icon(Icons.playlist_add_check_circle_sharp) : Icon(null),
          //                   title: Text(snapshot.data![index]["title"]),
          //                   subtitle: Text(snapshot.data![index]["artistName"]),
          //                   leading: Icon(Icons.music_note),
          //
          //                   onTap: (){
          //                     print("Hi you have pressed on id {$index}");
          //
          //                     Navigator.push(context,MaterialPageRoute(builder: (context)=> Playlistsongscreen(songs: widget.songs, currentIndex: index, playListName: k,)));
          //                   }
          //                 ),
          //
          //               );
